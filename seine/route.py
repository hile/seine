...
class IPRoutingTable(object):
    def __init__(self):
        self.log = Logger('route').default_stream
        self.ipv4 = []
        self.ipv6 = []
        try:
...
class Route(object):
    def __init__(self,address,gateway,gateway_type,interface=None,expire=None,flags=None,refs=None,used=None):
        self.log = Logger('route').default_stream
...
class IPv4Route(Route):
    def __init__(self,address,gateway,gateway_type,flags=None,refs=None,used=None,interface=None,expire=None):
        ...
        if expire is not None:
            expire = int(expire)
        Route.__init__(self,address,gateway,gateway_type,refs=refs,used=used,interface=interface,expire=expire)
...
class IPv6Route(Route):
    def __init__(self,address,gateway,gateway_type,flags=None,interface=None,expire=None):
        if flags is not None:
            flags = list(flags)
        if expire is not None:
            expire = int(expire)
        Route.__init__(self,address,gateway,gateway_type,flags=flags,interface=interface,expire=expire)
